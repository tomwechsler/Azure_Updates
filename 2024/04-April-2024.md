...
https://azure.microsoft.com/en-us/updates/azure-spring-apps-feature-update-q1-2024-save-up-to-47-with-azure-savings-plan/

**General availability: Mexico Central region added to Azure HDInsight**  
https://azure.microsoft.com/en-us/updates/hdinsightmexicocentral/

**Public Preview: Azure HDInsight on AKS is now available for preview in 7 new regions**  
https://azure.microsoft.com/en-us/updates/hdionaksnewregions/
...
**Generally Available: Azure Chaos Studio supports Resource tags**  
https://azure.microsoft.com/en-us/updates/generally-available-azure-chaos-studio-supports-resource-tags/

**Public preview: Azure Monitor pipeline (at edge)**  
https://azure.microsoft.com/en-us/updates/public-preview-azure-monitor-pipeline-at-edge/


**Infrastructure and quality enhancements for Azure Container Registry**  
https://azure.microsoft.com/en-us/updates/infrastructure-and-quality-enhancements-for-azure-container-registry/


**Public Preview: Azure Dedicated Host - Redeploy**  
https://azure.microsoft.com/en-us/updates/public-preview-host-redeploy/


**General availability: Improved network topology experience in Network Watcher and Azure Monitor Network Insights**  
...
https://azure.microsoft.com/en-us/updates/updated-retirement-notice-azure-data-catalog-will-now-be-retired-on-15-may-2024/


**Public preview: Extensibility model in Azure Deployment Environments**  
https://azure.microsoft.com/en-us/updates/public-preview-extensibility-model-in-azure-deployment-environments/


**Public preview: Azure Change Analysis New Portal Experience**  
https://azure.microsoft.com/en-us/updates/public-preview-azure-change-analysis-new-portal-experience/


**General availability: Application Gateway Web Application Firewall (WAF) inspection limit & size enforcement**  
https://azure.microsoft.com/en-us/updates/general-availability-application-gateway-web-application-firewall-waf-inspection-limit-size-enforcement/


**Generally Available: Index Advisor in Azure Cosmos DB helps optimize your index policy for NoSQL queries**  
https://azure.microsoft.com/en-us/updates/generally-available-index-advisor-in-azure-cosmos-db-helps-optimize-your-index-policy-for-nosql-queries/


**General availability: Semantic caching with vCore-based Azure Cosmos DB for MongoDB**  
https://azure.microsoft.com/en-us/updates/general-availability-semantic-caching-with-vcore-based-azure-cosmos-db/


**Public preview: Filtered vector search in vCore-based Azure Cosmos DB for MongoDB**  
https://azure.microsoft.com/en-us/updates/public-preview-filtered-vector-search-in-vcore-based-azure-cosmos-db-for-mongodb/


**General availability: Azure Database for PostgreSQL - Flexible Server enhanced disaster recovery features**  
https://azure.microsoft.com/en-us/updates/general-availability-azure-database-for-postgresql-flexible-server-enhanced-disaster-recovery-features/


**General availability: Azure Cosmos DB for PostgreSQL geo-redundant backup and restore**  
https://azure.microsoft.com/en-us/updates/general-availability-azure-cosmos-db-for-postgresql-georedundant-backup-and-restore/


**General availability: HNSW vector index in vCore-based Azure Cosmos DB for MongoDB**  
https://azure.microsoft.com/en-us/updates/general-availability-hnsw-vector-index-in-vcore-based-azure-cosmos-db-for-mongodb/
...
**Azure Virtual Network Manager security admin rule generally available in all public regions**  
